...
# calculae the z-score(mean-std normalization) of images
...
model = Sequential()
model.add(
    Conv2D(32, (3, 3), padding='same', kernel_regularizer=regularizers.l1(weight_decay), input_shape=x_train.shape[1:]))
...
model.add(Conv2D(128, (3, 3), padding='same', kernel_regularizer=regularizers.l1(weight_decay)))
model.add(Activation('elu'))
model.add(BatchNormalization())
model.add(Conv2D(128, (3, 3), padding='same', kernel_regularizer=regularizers.l1(weight_decay)))
model.add(Activation('elu'))
